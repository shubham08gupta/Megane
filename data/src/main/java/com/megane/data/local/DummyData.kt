...
val moviesList = listOf(
    ...
    Movie(
        ...
        description = "Professor Albus Dumbledore knows the powerful, dark wizard Gellert " +
                ...
                " him alone, he entrusts magizoologist Newt Scamander to lead an intrepid team " +
                " of wizards and witches. They soon encounter an array of old and new beasts as" +
                " they clash with Grindelwald's growing legion of followers.",
    ...
    Movie(
        ...
        description = "After settling in Green Hills, Sonic is eager to prove he has what it" +
                ...
                " with a new partner, Knuckles, in search for an emerald that has the power to" +
                " destroy civilizations. Sonic teams up with his own sidekick, Tails, and " +
                "together they embark on a globe-trotting journey to find the emerald before it " +
